...
CREATE_TABLE(
 ...
 'CREATE TABLE Projects (
    BCWSCP_HRS NUMBER(21,6) DEFAULT (0) NOT NULL,
    COL1 NUMBER(21,6) DEFAULT (0) NOT NULL
)
 %TABLETABLESPACE%'
);


ADD_COLUMN_COMMENT('Projects', 'BCWSCP_HRS', 'Current Period Budget Hours');
ADD_COLUMN_COMMENT('Projects', 'COL1', 'Current Period Budget Hours');
